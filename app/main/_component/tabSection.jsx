    ...
    <Tabs aria-label="Pills" style="pills">
      <Tabs.Item active title="몬콜레는 무엇인가요?">
        <p className="mt-3">
          ...
          과거에는 싸구려틱한 유광처리가 호불호가 갈렸으나 현재는 무광으로
          나온다. 단종된 피규어와 꾸준히 새로 나오는 피규어를 비교해 보면
          포켓몬의 디자인 변화나 기술의 발달이 반영되었음을 알 수 있다.
        </p>
        <Image
        ...
        <p className="text-xs font-light text-gray-500 mx-24 my-2">
          ...
          파이리와 리자몽의 크기가 같다는 단점이 있었으나 현재는 사이즈가
          노말(약 4cm), 슈퍼(약 10cm), 하이퍼(약 15cm) 사이즈로 나눠져서 나와서
          사이즈를 고를 수 있다. 받침대 없이 똑바로 세워 계속 둘 수 있을 정도로
          하중 분배에 큰 신경을 써 설계되었다.
        </p>
      </Tabs.Item>
